...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(boxAnno.getValue()!=null) {
    		...
    		txtResult.setText("Devi prima selezionare un anno.");
    		return;
    	}
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	...
    	if(boxRegista.getValue()!=null) {
    		...
    		for(Adiacenza a : this.model.getAdiacenze(d)) {
    			if(a.getD1().equals(d)) {
    		...
    		txtResult.setText("Devi prima selezionare un regista.");
    		return;
    	}
    }
    ...
    void doRicorsione(ActionEvent event) {
    	...
    	for(Director d : this.model.ricorsione(this.boxRegista.getValue(), c)) {
    		this.txtResult.appendText("\n"+d.toString());
    	}
    	
    	this.txtResult.appendText("\nNumero attori condivisi: "+this.model.getSomma());
    }
